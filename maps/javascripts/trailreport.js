   ...
   function sendPosition (position) {
       ...
       var emailBody = href+'%23map%3D18/'+position.coords.latitude.toFixed(6)+'/'+position.coords.longitude.toFixed(6)+'/mark/'+ position.coords.accuracy.toFixed(2)+'%0D%0A%0D%0ATell us about the trail issue and attach a photo to help us assess the work required.';
